...
$(document).ready(function() {
    ...
    table = $("#table-caddy").DataTable({
        ...
        ajax: {
            url: rootWebService + "CaddyMaster/Tampil_Data_Caddy",
            type: "POST",
        },
    ...
    //FUNCTION Non-Aktif
    $("#show_data").on("click", ".caddy_non_aktif", function() {
        ...
        Notiflix.Confirm.Show(
            ...
            function() {
                $.ajax({
                    type: "POST",
                    url: rootWebService + "CaddyMaster/DeactivedCaddy",
                    dataType: "JSON",
                    data: { nip: id_nip },
    ...
    //FUNCTION Aktif
    $("#show_data").on("click", ".caddy_aktif", function() {
        var id_nip = $(this).attr("id");
        var data_nama = $(this).attr("data");
        Notiflix.Confirm.Show(
            "Konfrimasi",
            ...
            function() {
                $.ajax({
                    type: "POST",
                    url: rootWebService + "CaddyMaster/ActivedCaddy",
                    dataType: "JSON",
                    data: { nip: id_nip },
                    success: function(data) {
                        var msg = data.msg;
