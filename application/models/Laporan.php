...
class Laporan extends CI_Model
{
    ...
    var $column_order = array('t_laporan.periode_laporan', 't_laporan.tgl_dibuat', 't_user.nama'); //set column field database for datatable orderable
    var $column_search = array('t_laporan.periode_laporan', 't_laporan.tgl_dibuat', 't_user.nama'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where(['t_laporan.stat_laporan' => 'LM']);
