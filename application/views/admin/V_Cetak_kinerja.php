                        ...
                        <table width="100%" border="1" cellpadding="10px">
                            <tr>
                                <td class="text-center gambar" rowspan="5" width="20%">
                                    <img class="img-fluid img-thumbnail rounded-circle m-1" src="<?= base_url('assets/'); ?>images/profil/<?= $foto; ?> " style="width: 90px" />
                                </td>
                                <td width=" 30% ">Nama</td>
                                <td>: <?= $nama_caddy; ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>: <?= date('d/m/Y', strtotime($bergabung)) ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        $(function() {
            ...
            var dataPenilaian = {
                ...
                datasets: [{
                    ...
                    data: [<?= $k->total_poor; ?>, <?= $k->total_average; ?>, <?= $k->total_good; ?>, <?= $k->total_excellent; ?>],
                    backgroundColor: [
                        "rgba(222, 0, 0, 0.9)",
                        "rgba(255,171,0,0.9)",
                        "rgba(255, 206, 86, 0.9)",
            ...
            var dataAbsen = {
                ...
                datasets: [{
                    label: "Penilaian Pemain",
                    data: [<?= $k->total_absen; ?>, <?= $k->total_alpa; ?>, <?= $k->total_sakit; ?>],
                    backgroundColor: [
                        "rgba(107, 255, 59, 0.9)",
                        "rgba(222, 0, 0, 0.9)",
                        "rgba(255, 206, 86, 0.9)",
            ...
            if ($("#absensiChart").length) {
                var barChartCanvas = $("#absensiChart").get(0).getContext("2d");
            ...
            if ($("#nilaiChart").length) {
                var barChartCanvas = $("#nilaiChart").get(0).getContext("2d");
                // This will get the first returned node in the jQuery collection.
                var barChart = new Chart(barChartCanvas, {
                    type: "bar",
                    data: dataPenilaian,
