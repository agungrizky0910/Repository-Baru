...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/404-template/'); ?>style.css">
...
<body>
    ...
    <body class="permission_denied">
        ...
        <div class="denied__wrapper">
            <h1>404</h1>
            <h3>LOST IN <span>SPACE</span> Kinerja Caddy? Hmm, looks like that page doesn't exist.</h3>
            ...
            <button class="denied__link" onclick="history.back();">Go Home</button>
        </div>
        <!-- partial -->
        <script src='<?= base_url('assets/404-template/'); ?>particles.min.js'></script>
        <script src="<?= base_url('assets/404-template/'); ?>script.js"></script>
